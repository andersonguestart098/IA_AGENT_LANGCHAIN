...
class BaseKnowledgeBase(_PrismaModel):
    __prisma_model__: ClassVar[Literal['KnowledgeBase']] = 'KnowledgeBase'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.KnowledgeBaseActions[_PrismaModelT]':
